...
Зачем разделять: 152-ФЗ требует прекратить обработку после отзыва, но
59-ФЗ обязывает ответить на ранее поданное обращение. Эти два закона
сходятся в правиле: «обращения, поданные до отзыва согласия,
обрабатываются по 59-ФЗ; новые после отзыва — не принимаются». Без
точки отзыва эту границу установить невозможно.
