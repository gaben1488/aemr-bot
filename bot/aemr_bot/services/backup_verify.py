...
боевая. Полноценное DR-учение — ручная процедура раз в квартал по
регламенту (раздел «Резервное копирование» в вике): человек, отдельный
хост, без спешки. Здесь — дешёвый сторож, который может работать хоть
каждую неделю и ничего не рискует.
