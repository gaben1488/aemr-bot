...
CANCEL_ALREADY_DONE = (
    "Эта кнопка уже не нужна. Обращение либо отправлено, либо "
    "отменено ранее.\n"
    "\n"
    "Чтобы дополнить отправленное обращение, откройте «📂 Мои "
    "обращения».\n"
    "Чтобы подать новое, нажмите «📝 Написать обращение» в главном "
    "меню."
)
