...
OP_HELP_MAIN = (
    "📋 ПАМЯТКА ОПЕРАТОРА\n"
    "\n"
    "Бот aemr-bot — обратная связь Администрации Елизовского "
    "муниципального округа в MAX. Большинство действий — кнопками. "
    "Команды нужны для скрытых действий и опытным операторам.\n"
    "\n"
    "━━━━━━━━━━━━━━━━\n"
    ...
    "• Между подтверждением и отправкой — пауза 5 минут. Маркер [ЧС] "
    "в начале сокращает паузу до 30 секунд. Только для реальных ЧС.\n"
    ...
    "/broadcast · /broadcast list · маркер [ЧС] в тексте\n"
    "\n"
    ...
    "\n"
    "Аудитория (только ИТ):\n"
    "Кнопка «📊 Аудитория и согласия». 10 жителей на страницу, "
    "поиск по имени, телефону или MAX id, выгрузка списком, "
    "блок и erase под карточкой.\n"
    "\n"
    "Стандартные:\n"
