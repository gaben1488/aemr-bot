...
CONSENT_REQUEST = (
    ...
    "персональных данных.\n\n"
    "Бот обработает: имя, телефон, идентификатор вашего аккаунта в MAX "
    "(технический номер), населённый пункт и адрес проблемы, текст и "
    "вложения обращения — только для приёма обращения, передачи "
    "оператору Администрации и ответа вам.\n\n"
