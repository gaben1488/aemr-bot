...
OP_HELP_FULL_LEGACY = (
    ...
    "2. Направить в МВД: 8-800-250-30-72 или личный приём в отделе "
    "МВД по Елизовскому муниципальному округу.\n"
    "3. Зафиксировать факт followup'ом в обращении.\n"
    "4. Уведомить ИТ-оператора через служебную группу.\n"
    "\n"
