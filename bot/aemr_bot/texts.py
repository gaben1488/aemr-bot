...
CONSENT_REVOKE_CONFIRM = (
    ...
    "Что произойдёт:\n"
    "• Новые обращения подавать нельзя, пока не дадите согласие заново.\n"
    "• Уже поданные обращения оператор доработает в обычном порядке.\n"
    "• Подписка на рассылку отключится.\n"
    "• Имя и телефон сохранятся в журнале — до запроса на полное удаление.\n\n"
...
ERASE_CONFIRM = (
    ...
    "• Согласие на обработку отозвано, подписка на рассылку отключена.\n"
    "• Открытые обращения (если есть) будут закрыты.\n"
    "• Бот вас «забудет» — при следующем заходе пройдёте воронку "
    "с чистого листа.\n\n"
    "Действие необратимо."
)

ERASE_REQUESTED = (
    "Готово. Ваши данные удалены, согласие отозвано, подписка отключена.\n\n"
    "Если захотите написать снова — просто откройте /start. Бот пройдёт "
    "с вами воронку как с новым посетителем."
)
