...
CONSENT_REVOKE_CONFIRM = (
    ...
    "согласия на ПДн).\n"
    "• Подписка на рассылку отключится: она тоже требует согласия.\n"
...
CONSENT_REVOKED_OK = (
    "Согласие отозвано. Подписка на рассылку отключена. Открытые "
...
SUBSCRIBE_BUTTON_ON = "🔔 Подписаться на рассылку"
SUBSCRIBE_BUTTON_OFF = "🔕 Отписаться от рассылки"
