...
SETTINGS_MENU_TITLE = (
    "Настройки и помощь.\n\n"
    "Здесь — список команд, политика обработки данных и кнопка «Уйти из "
    "бота» на случай, если рассылка стала надоедать или вы хотите "
    "попрощаться."
)
...
GOODBYE_PROMPT = (
    ...
    "👋 Если хотите попрощаться, но у вас есть открытое обращение — "
    "оператор обязательно ответит, и только после этого мы перестанем "
    "обрабатывать ваши данные. Новые обращения подавать будет нельзя.\n\n"
