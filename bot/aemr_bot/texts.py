...
TOPIC_RECEIVED = (
    "✅ Тематика выбрана. Опишите суть обращения. "
    "Можно прикрепить фото и геолокацию. Можно несколько сообщений подряд — "
    "соберём всё вместе.\n\n"
...
APPEAL_EMPTY_REJECTED = (
    ...
    "Например: «Во дворе ул. N, K неделю не вывозят мусор». "
