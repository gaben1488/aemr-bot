...
# Echo-feedback в FSM-воронке: первой строкой каждого шага идёт «✓ Что:
# выбрано» — пенсионер видит, что именно зафиксировалось, и не сомневается.
# Без echo выбор ощущался незаконченным («нажал — а оно куда-то ушло»).
NAME_RECEIVED = "✓ Имя: {name}\n\nВыберите населённый пункт."

LOCALITY_RECEIVED = (
    "✓ Населённый пункт: {locality}\n\nУкажите адрес — улица и дом."
)

ADDRESS_RECEIVED = "✓ Адрес: {address}\n\nВыберите тематику обращения."

TOPIC_RECEIVED = (
    "✓ Тема: {topic}\n\n"
    "Опишите суть обращения одним сообщением. "
...
UNKNOWN_INPUT = (
    "Не понял сообщение. Откройте меню — кнопки внизу экрана. "
    "Если меню скрыто, наберите /start."
)
...
HELP_USER = (
    ...
    "муниципального округа ответит через бот.\n"
    ...
    "⚙️ Настройки и помощь — политика обработки данных и кнопка «Уйти из "
    "бота» на случай, если рассылка стала надоедать или хотите попрощаться.\n\n"
