...
Полная документация собрана в виде красивых страниц. Откройте **[docs/site/index.html](docs/site/index.html)** — единая точка входа. Внутри разделы по ролям: жителю, оператору, администратору, плюс концепция и безопасность. Страницы открываются в любом браузере и работают без интернета.
