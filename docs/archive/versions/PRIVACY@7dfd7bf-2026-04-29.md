...
**Чат-бот:** «Администрация ЕМР. Обратная связь» (`@aemr_feedback_bot`)
**Адрес в MAX:** https://max.ru/aemr_feedback_bot

> Один плейсхолдер [РЕКВИЗИТЫ ОПЕРАТОРА — указать перед публикацией: наименование, юридический адрес, ИНН/ОГРН, контактный e-mail] остаётся для подстановки реквизитов АЕМР перед публикацией: наименование, юридический адрес, ИНН/ОГРН, контактный e-mail для запросов субъектов ПДн.
...
[РЕКВИЗИТЫ ОПЕРАТОРА — указать перед публикацией: наименование, юридический адрес, ИНН/ОГРН, контактный e-mail]
