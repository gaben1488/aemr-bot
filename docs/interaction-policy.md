...
- `answered` and `closed` appeals are completed for followups and use a repeat/feedback appeal instead.
...
- the topic is marked as feedback, for example: `<topic>: feedback on answered/closed appeal`.