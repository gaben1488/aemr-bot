...
границы ответственности. Все факты сверены с фактическим кодом — поведение
указано так, как оно реально реализовано в `bot/aemr_bot/`.
...
операторы не имеют технической возможности заблокировать жителя через UI —
для эскалации они обращаются к ИТ.
