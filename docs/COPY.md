...
CONSENT_BLOCKED_NEW_APPEAL:
Сейчас вы не можете подать новое обращение: согласие на обработку персональных данных отозвано. Дайте согласие заново — кнопка ниже.
```
...
SUBSCRIBE_REQUIRES_CONSENT:
Чтобы подписаться на рассылку, нужно сначала дать согласие на обработку персональных данных. Это требование 152-ФЗ. Откройте «Настройки и помощь» → «Согласие на ПДн».
