...
Содержание оставлено почти без изменений в следующих документах (по результатам сверки расхождений не выявлено или они некритичны): `SECURITY.md`, `BACKUP_RESTORE_TEST.md`, `VPS_SMOKE_CHECKLIST.md`, `ROLLBACK.md`, `SYSADMIN.md`, `PRIVACY_DRAFT.md`, `Политика.md`, `Политика_v2.md`.
